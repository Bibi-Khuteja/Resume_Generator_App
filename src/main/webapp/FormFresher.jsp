        ...
        <form action="http://localhost:8080/Resume_Management/InsertData" method="post">
          <div class="col-md-6 form-line">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <label for="education">PUC/12th:</label>
                <p onclick="educationThree()" style="color: white;" class="btn btn-lg">add</p>
                <ul>
              ...
              <div class="form-group">
                <label for="education">SSLC/10th:</label>
                <p onclick="educationFour()" style="color: white;" class="btn btn-lg">add</p>
                <ul>
