	...
	<div class="container">
						...
						<div class="left">
							...
							<div class="section__list-item">
								<div class="left">
									...
									<div class="name"><%=exp1From%></div>
									<div class="outcome"><%=exp1To%></div>
								</div>
							...
							<div class="section__list-item">
								<div class="left">
									...
									<div class="name"><%=exp2From%></div>
									<div class="outcome"><%=exp2To%></div>
								</div>
		...
		<div class="section">
			...
			<div class="section__list">
				...
				<%
				if (pro3Title != null && pro3Desc != null && pro3Tech != null && !pro3Title.trim().isEmpty()
						&& !pro3Desc.trim().isEmpty() && !pro3Tech.trim().isEmpty()) {
				%>

				<div class="section__list-item">
					<div class="name"><%=pro3Title%></div>
					<b>Desc:</b>
					<div class="desc"><%=pro3Desc%></div>
					<b>Technology used:</b>
					<div class="tech"><%=pro3Tech%></div>
				</div>
				<%
				}
				%>
		...
		<div class="section">
			<div class="section__title">DECLARATION</div>
